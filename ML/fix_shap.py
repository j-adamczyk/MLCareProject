...
"""
This file has been taken out from the SHAP library. It fixes the bug with 
creating plots for data with missing values (e.g. NaN, None). Importing this 
file overwrites the draw_labels() functio in the SHAP library with the fixed 
one below.

This is a workaround, since the PR with fix that I've made has not been 
approved yet. When it's fixed in SHAP, this file can be safely removed.
"""
